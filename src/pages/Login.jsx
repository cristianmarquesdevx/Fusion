...
export default function Login() {
  ...
  const handleGithubLogin = async () => {
    ...
    if (!result.success) {
      showToast(result.error || 'Erro ao conectar com GitHub.', 'error');
    }
  };
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-800 font-semibold text-sm shadow-lg shadow-black/5 hover:shadow-xl hover:shadow-black/10 transition-all duration-200 border border-gray-200"
            >
              {loading ? (
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl bg-[#24292F] hover:bg-[#1B1F23] active:bg-[#14171A] text-white font-semibold text-sm shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/15 transition-all duration-200 border border-white/10"
            >
              {loading ? (
