...
begin
  ...
  if v_count = 0 then
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000003',
      'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001',
      current_date, '09:00', 60, 180.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002',
      'd0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002',
      current_date, '10:00', 45, 250.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000002',
      'd0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000005',
      current_date, '11:30', 30, 890.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000003',
      'd0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000001',
      current_date, '12:15', 50, 180.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000002',
      'd0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002',
      current_date, '13:00', 60, 450.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000002',
      'd0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000004',
      current_date, '14:30', 60, 1200.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000004',
      'd0000000-0000-0000-0000-000000000007', 'c0000000-0000-0000-0000-000000000003',
      current_date, '15:00', 60, 200.00);
    perform public.criar_agendamento('a0000000-0000-0000-0000-000000000001',
      '10000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000003',
      'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001',
      current_date, '16:00', 60, 180.00);
  end if;
end;
$$;
